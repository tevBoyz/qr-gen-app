...
const QRCodeGenerator = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 flex flex-col items-center justify-start p-4 rounded-2xl">
        <img className='h-30' src="/qr-code.png" alt=""/>
        <h1 className="text-4xl md:text-3xl font-extrabold text-indigo-700 mt-10 mb-4 drop-shadow-md">QR Generator</h1>
